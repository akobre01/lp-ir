...
#    print "ALG & obj & makepsan & #violations & min score & mean score & std score"
    print " & & %0.2f & %0.2f & %d (%0.1f\%%) & % 0.2f & %0.2f & %0.2f & \\\\" % (analyzer.obj(), analyzer.makespan, analyzer.num_ms_vio(), 100.0 * analyzer.num_ms_vio() / len(analyzer.weights[0]), analyzer.min_score(), analyzer.mean_score(), analyzer.std_score())
