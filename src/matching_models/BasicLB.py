...
class BasicLB(object):
    """The basic paper matching formulation with lower bound."""
    # TODO(AK): We should add reviewer lower bounds to this.
    def __init__(self, loads, load_lb, coverages, weights):
        ...
        for r, l in enumerate(self.load_lb):
            self.m.addConstr(sum(self.lp_vars[r]) >= l, "r_lb" + str(r))
