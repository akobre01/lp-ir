...
class MsFlow(object):
    ...
    """
    def __init__(self, loads, coverages, weights, sol=None, ms=0.0):
        ...
        self.orig_weights = weights.copy()
    ...
    def objective_val(self):
        ...
        return np.sum(self.sol_as_mat() * self.orig_weights)
    ...
    def find_ms(self):
        ...
        for ms in np.arange(mn, mx + mx/20.0, mx / 20.0):
