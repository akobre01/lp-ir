"""Run the drop all makespan matcher using LP solver."""
import argparse
import datetime
import numpy as np
import os
...
from matching_models.IRDA import IRDA
...
if __name__ == "__main__":
    ...
    bm = IRDA(loads, covs, scores, makespan=ms)
    s = time.time()
