...
from ..matching_models.AL1E import AL1E

if __name__ == "__main__":
    """Solve the at least 1 expert paper matching using gurobi's heuristics.
    ...
    bb = AL1E([max_load] * n_rev, [coverage] * n_pap, weights)
    s = time.time()
    if args.expert:
