...
from ..matching_models.BasicLB import BasicLB

if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='Run the baseline w/ lower load bound on a dataset.')
    parser.add_argument('load_const', type=int, help='max papers per rev.')
    parser.add_argument('load_lb', type=int, help='min papers per rev.')
    ...
    bm = BasicLB([max_load] * n_rev, [min_load] * n_rev,
