...
if __name__ == '__main__':
    ...
    The expert survival plot looks at the max reviewer score per paper and
    ...
    ax.set_xlabel('Max Reviewer Affinity')
    ax.set_title('Expert Survival')
    ...
    for l in leg.get_texts():
        l.set_color(LABEL_COLOR)
    fig.savefig('%s/expert.png' % args.input)
