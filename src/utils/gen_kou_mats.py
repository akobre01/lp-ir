...
if __name__ == "__main__":
    ...
    np.save("kou_pap_mat_dm08", np.array(pap_mat))
    np.save("kou_rev_mat_dm08", np.array(rev_mat))
    np.save("kou_pap_tensor_dm08", paper_tensor)
    np.save("kou_rev_tensor_dm08", reviewer_tensor)
    np.save("kou_score_mat_dm08", score_mat)
    # np.save("kou_pap_mat_db08", np.array(pap_mat))
    # np.save("kou_rev_mat_db08", np.array(rev_mat))
    # np.save("kou_pap_tensor_db08", paper_tensor)
    # np.save("kou_rev_tensor_db08", reviewer_tensor)
    # np.save("kou_score_mat_db08", score_mat)
